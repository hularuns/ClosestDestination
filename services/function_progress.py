...
def function_progress(start_time, end_time, ongoing_time, total_tasks, cumulative_time_total, 
    ...
    Parameters:
        ...
        pred_percentage_complete: If true will print the percentage progress, updated each loop.
    ...
    if len(ongoing_time) > 0:
        ...
        task_progress = (cumulative_time_total / total_predicted_time) * 100
        ...
        if pred_percentage_complete:
            print(f'Function is {round(task_progress, 2)}% complete based on time spent.')
